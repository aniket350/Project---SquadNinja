...
public interface TeamRecommendationRepository extends Neo4jRepository<SubDomain, Long> {
    @Query("match(r:Roles)-[p:played_by]->(sp:ServiceProvider)-[hs:has_skill]-(sk:Skills),(i:Idea)-[re:requires]->(r:Roles)-[h:have]->(s:Skills) where i.title={title} and r.roleName={roleName} return sp ")
